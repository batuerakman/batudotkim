...
class _DashboardWidgetState extends State<DashboardWidget> {
  ...
  void initState() {
    super.initState();
    _initializationFuture = _initSoundController();
  }

  Future<void> _initSoundController() async {
    final soundController = SoundController();
    await soundController.initialize(); // New method to ensure proper initialization
    if (mounted) {
      Provider.of<SoundController>(context, listen: false).dispose();
      Provider.of<SoundController>(context, listen: false).updateController(soundController);
    }
  }
